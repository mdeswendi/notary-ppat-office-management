  ...
  return (
    <PageContainer>
      <div className="flex flex-col gap-1">
        <h1 className="text-2xl font-semibold tracking-tight">{t("matters")}</h1>
        <p className="text-muted-foreground">{t("mattersSubtitle")}</p>
      </div>

      <ReportSurface definition={REPORTS["operational.matters"]} />
    </PageContainer>
  );
}
