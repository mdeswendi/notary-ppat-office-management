  ...
  return (
    <PageContainer>
      <div className="flex flex-col gap-1">
        <h1 className="text-2xl font-semibold tracking-tight">{t("warkah")}</h1>
        <p className="text-muted-foreground">{t("warkahSubtitle")}</p>
      </div>

      <ReportSurface definition={REPORTS["ppat.warkah"]} />
    </PageContainer>
  );
}
