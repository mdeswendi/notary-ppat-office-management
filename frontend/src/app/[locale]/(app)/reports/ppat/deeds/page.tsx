  ...
  return (
    <PageContainer>
      <div className="flex flex-col gap-1">
        <h1 className="text-2xl font-semibold tracking-tight">{t("ppatDeeds")}</h1>
        <p className="text-muted-foreground">{t("ppatDeedsSubtitle")}</p>
      </div>

      <ReportSurface definition={REPORTS["ppat.deeds"]} />
    </PageContainer>
  );
}
