          ...
          <dd className="text-sm">
            {minuta.document ? (
              <Link
                ...
                className="text-primary focus-visible:ring-ring rounded-sm font-medium underline underline-offset-4 focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:outline-none"
              >
