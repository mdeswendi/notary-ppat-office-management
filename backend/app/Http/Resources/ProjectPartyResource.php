...
/**
 * One Project participation (M3.4, D-098).
 *
 * **The Party appears as a minimal stub, and that is the whole of it.** No NIK,
 * no NPWP, no `tax_id`, no masks, no addresses, no contact details — and no
 * masks specifically, because a mask is still a statement about a sensitive
 * value and this surface has no business making one (D-082, the same reasoning
 * `CompanyManagementResource` follows).
 *
 * `projects.parties.view` says who may know which Parties are involved in a
 * piece of work. It says nothing whatever about those Parties' identity
 ...
 * its own Data Scope. It is presentation only — the Party endpoints authorize
 ...
 *
 * **A Party the actor cannot open still appears.** The participation is Project
 * data recorded by the office; hiding the row would misreport the Project's
 ...
 * @mixin ProjectParty
 */
class ProjectPartyResource extends JsonResource
{
    /**
     * @param  array<string, bool>  $capabilities
     */
    public function __construct(
        ProjectParty $resource,
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            // classified the involvement (D-092).
            'role_code' => $this->role_code,

            // A designation, not an assertion of legal or client authority, and
            // under no cardinality rule — several may be true at once.
